    ...
    return (
        <button
            ...
            className={classNames("rounded border font-semibold", {
                ...
                "bg-yellow-50 border-yellow-300 hover:border-yellow-500 hover:bg-yellow-100 text-yellow-700": variant === 'warning',
                "bg-green-50 border-green-300 hover:border-green-500 hover:bg-green-100 text-green-700": variant === 'success',
                "bg-red-50 border-red-300 hover:border-red-500 hover:bg-red-100 text-red-700": variant === 'danger',
